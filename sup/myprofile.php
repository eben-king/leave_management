...
header('location:index.php');
    ...
    if(isset($_POST['update'])){
        ...
        $phone=$_POST['phone']; 
        $email=$_POST['email'];
        $sql="update tblemployees set fname=:fname,lname=:lname,address=:address,phone=:phone, email=:email where staffid=:hodid";
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            ...
                                            <form class="form" method="POST" action="">
                                                ...
                                                $sql = "SELECT * from  tblemployees where staffid=:hodid";
                                                $query = $dbh -> prepare($sql);
                                                $query -> bindParam(':hodid',$hodid, PDO::PARAM_STR);
                                                $query->execute();
