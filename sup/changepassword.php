...
$sql ="SELECT `password` FROM tblemployees WHERE staffid=:hodid and `password`=:password";
$query= $dbh -> prepare($sql);
$query-> bindParam(':hodid', $hodid, PDO::PARAM_STR);
$query-> bindParam(':password', $password, PDO::PARAM_STR);
$query-> execute();
$results = $query -> fetchAll(PDO::FETCH_OBJ);
if($query -> rowCount() > 0)
{
$con="update tblemployees set Password=:newpassword where staffid=:hodid";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(':hodid', $hodid, PDO::PARAM_STR);
