...
<body class="vertical-layout vertical-menu 1-column bg-blue-grey  menu-expanded blank-page blank-page" data-open="click" data-menu="vertical-menu" data-col="1-column">
    <!-- ////////////////////////////////////////////////////////////////////////////-->
    <!-- Navigation -->
    <header>
        ...
        <div class="navbar-container content">
          <div class="collapse navbar-collapse" id="navbar-mobile">
            <ul class="nav navbar-nav float-right">    
              <li class=" nav-item"><a class="nav-link" href="../index.php" data-toggle="dropdown"><span class="avatar avatar-online"></span><span class="user-name">Staff</span></a>
              </li>
            </ul>
              </div>
          </div>
            ...
            <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                    <div class="card-title text-center">
                        ...
                        <h5 class='text-danger'>Default password: admin</h5>
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-simple" action="" method="POST" novalidate>
                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                <input type="text" class="form-control form-control-lg input-lg" id="user-name" placeholder="User Name" required name="username">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 col-12 text-center text-md-right"><a href="recover.php" class="card-link">Forgot Password?</a></div> 
                            </div>
