...
if(isset($_POST['update'])) {
    ...
    $dle=$_POST['dle'];
    $dorod=$_POST['dorod'];
    $sql="update tblleaves set ldr=:ldr, dlc=:dlc, dle=:dle, dorod=:dorod, status=1 where id=:lid";
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" id="ol" type="text"  autocomplete="off" name="ol" value="<?php echo htmlentities($result->ol);?>"  readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" id="tle" type="text"  autocomplete="off" name="tle" value="<?php echo htmlentities($result->tle);?>"  readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="number" name="lafcy" id="lafcy" value="<?php echo htmlentities($result->lafcy);?>" readonly>
                                                                </div>
                                                                <div class="form-group">
