<div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
    ...
    <li class=" nav-item"><a href="#"><i class="icon-list"></i><span class="menu-title" data-i18n="nav.navbars.main">Leave Actions</span></a>
     <ul class="menu-content">
            <li><a class="menu-item" href="applyleave.php" data-i18n="nav.dash.ecommerce">Request Leave</a>
            </li>
            <li><a class="menu-item" href="leavehistory.php" data-i18n="nav.dash.ecommerce">Leave History</a>
            </li>
